...
static struct remoteproc_mem *
remoteproc_get_mem_from_pa(struct remoteproc *rproc,
			   metal_phys_addr_t pa, size_t size)
{
	return remoteproc_get_mem(rproc, NULL, pa, METAL_BAD_PHYS,
				  NULL, size);
}

static struct remoteproc_mem *
remoteproc_get_mem_from_da(struct remoteproc *rproc,
			   metal_phys_addr_t da, size_t size)
{
	return remoteproc_get_mem(rproc, NULL, METAL_BAD_PHYS, da, NULL, size);
}
