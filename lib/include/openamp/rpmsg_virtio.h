...
/*
 * split_shpool is a local OpenAMP option and is not part of the virtio
 * device configuration space ABI.
 */
#define RPMSG_VIRTIO_CONFIG_SIZE \
	((uint16_t)(sizeof(struct rpmsg_virtio_config) - sizeof(bool)))
